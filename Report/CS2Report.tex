...
The plots were zoomed in to the range where the response was interesting, and phase wrapping was not apparent.
This is because computers are inherently discrete, and the FFT assumes periodicity in the signal.
This can lead to phase wrapping if the frequency resolution is not sufficiently high, this is shown when the whole calculated response is plotted.
...
The magnitude of the detector and system output are scaled to a very small magnitude because the $h_d(t)$ has a very tiny area under its curve.
...
Correspondingly, the phase transitions smoothly from $90^\circ$ at negative frequencies, through $0^\circ$ at DC, down to $-90^\circ$ at positive frequencies, again very closely matching the theoretical prediction.
